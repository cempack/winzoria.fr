  ...
  return (
    <div className="flex w-full flex-col">
      <h1 className="text-2xl font-bold mb-4">
        Bienvenue sur le wiki officiel de Winzoria.
      </h1>
        ...
        <Link href="/wiki/commands">
          <Card x-chunk="dashboard-04-chunk-1">
            <CardHeader>
              ...
              <CardDescription>
                Ll&#39;ensemble des commandes auquel vous avez accès.
              </CardDescription>
            </CardHeader>
          </Card>
        </Link>
        <Link href="/wiki/ranks">
          <Card x-chunk="dashboard-04-chunk-2">
            <CardHeader>
              ...
              <CardDescription>
                Ll&#39;ensemble des grades ainsi que leurs permissions et prix.
              </CardDescription>
            </CardHeader>
          </Card>
        </Link>
        <Link href="/wiki/kits">
          <Card x-chunk="dashboard-04-chunk-3">
            <CardHeader>
              ...
              <CardDescription>
                Ll&#39;ensemble des kits ainsi que leurs contenus et moyen
                dl&#39;obtention.
              </CardDescription>
            </CardHeader>
          </Card>
        ...
        <Link href="/wiki/assets">
          <Card x-chunk="dashboard-04-chunk-4">
            <CardHeader>
              ...
              <CardDescription>
                Ll&#39;ensemble des atouts ainsi que leurs avantages.
              </CardDescription>
            </CardHeader>
          </Card>
        </Link>
