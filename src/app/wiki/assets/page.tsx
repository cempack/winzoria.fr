      ...
      <Tabs defaultValue="speed" className="w-full">
        ...
        <TabsContent value="speed">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Augmente la vitesse de déplacement de +20% par niveau.
              </CardDescription>
            </CardHeader>
          </Card>
        </TabsContent>
        ...
        <TabsContent value="fireResistance">
          <Card>
            <CardHeader>
              <CardTitle className="flex flex-row items-center gap-1">
                Ll&#39;atout de Résistance au feu :
              </CardTitle>
              <CardDescription>
                Vous protège du feu et de la lave. Vous serez insensible à la
                chaleur, et même un bain de lave ne vous fera aucun mal.
              </CardDescription>
            </CardHeader>
          </Card>
        </TabsContent>
        <TabsContent value="celerity">
          <Card>
            <CardHeader>
              <CardTitle className="flex flex-row items-center gap-1">
                Ll&#39;atout de Célérité :
              </CardTitle>
              <CardDescription>
                Augmente la vitesse de minage de +20% par niveau.
              </CardDescription>
            </CardHeader>
          </Card>
        </TabsContent>
        <TabsContent value="regeneration">
          <Card>
            <CardHeader>
              <CardTitle className="flex flex-row items-center gap-1">
                Ll&#39;atout de Régénération :
              </CardTitle>
              <CardDescription>
                Vous régénère de la vie très rapidement (1 coeur toutes les 5
                secondes).
              </CardDescription>
            </CardHeader>
          </Card>
