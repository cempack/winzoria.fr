      ...
      <Tabs defaultValue="warrior" className="w-full">
          ...
          <Card>
            <CardHeader>
              <CardTitle className="flex flex-row items-center gap-1">
                Le grade Guerrier <Swords size={18} />
              </CardTitle>
              <CardDescription>
                Ce grade vous est donné quand vous rejoignez le serveur.
              </CardDescription>
            </CardHeader>
        ...
        <TabsContent value="knight">
          <Card>
            <CardHeader>
              <CardTitle className="flex flex-row items-center gap-1">
                Le grade Chevalier <ShieldHalf size={18} />
              </CardTitle>
              <CardDescription>
                Pour obtenir ce grade il vous faudra payer 10 000 000$ et avoir
                le grade Guerrier.
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
        ...
        <TabsContent value="sovereign">
          <Card>
            <CardHeader>
              <CardTitle className="flex flex-row items-center gap-1">
                Le grade Souverain <Star size={18} />
              </CardTitle>
              <CardDescription>
                Pour obtenir ce grade il vous faudra payer 20 000 000$ et avoir
                le grade Chevalier.
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              ...
              <ul className="list-disc list-inside space-y-1">
                <li className="text-sm">
                  Accès aux commandes des grades antèrieurs
                </li>
                ...
                <li className="text-sm">
                  Accès à la commande /invsee [Joueur]
                </li>
              </ul>
            </CardContent>
          </Card>
        ...
        <TabsContent value="king">
          <Card>
            <CardHeader>
              <CardTitle className="flex flex-row items-center gap-1">
                Le grade Roi <Crown size={18} />
              </CardTitle>
              <CardDescription>
                Pour obtenir ce grade il vous faudra payer 45 000 000$ et avoir
                le grade Souverain.
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              ...
              <ul className="list-disc list-inside space-y-1">
                <li className="text-sm">
                  Accès aux commandes des grades antérieurs
                </li>
        ...
        <TabsContent value="emporor">
          <Card>
            <CardHeader>
              <CardTitle className="flex flex-row items-center gap-1">
                Le grade Empereur <Castle size={18} />
              </CardTitle>
              <CardDescription>
                Pour obtenir ce grade il vous faudra payer 100 000 000$ et avoir
                le grade Roi.
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              ...
              <ul className="list-disc list-inside space-y-1">
                ...
                <li className="text-sm">
                  Le Fly sl&#39;active automatiquement à ll&#39;entrée des
                  claims
                </li>
              </ul>
            </CardContent>
        ...
        <TabsContent value="legend">
          <Card>
            <CardHeader>
              <CardTitle className="flex flex-row items-center gap-1">
                Le grade Légende <Trophy size={18} />
              </CardTitle>
              <CardDescription>
                Pour obtenir ce grade il vous faudra payer 400 000 000$ et avoir
                le grade Empereur.
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              ...
              <ul className="list-disc list-inside space-y-1">
                ...
                <li className="text-sm">
                  Le Fly sl&#39;active automatiquement
                </li>
              </ul>
            </CardContent>
          </Card>
