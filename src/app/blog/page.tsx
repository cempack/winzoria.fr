    ...
    return (
        <main className="flex min-h-[calc(100vh_-_theme(spacing.16))] flex-1 flex-col gap-4 bg-muted/40 md:gap-8">
            <div className="container mx-auto px-4 py-12 md:px-6 p-16">
                                ...
                                <div className="space-y-4">
                                    <div className="flex items-center space-x-4">
                                        ...
                                        <div>
                                            ...
                                            <div
                                                className="flex flex-row items-center gap-1 text-sm text-gray-500 dark:text-gray-400">
                                                <Eye size={16}/> 1.2K
                                            </div>
                                        </div>
                                    </div>
              ...
              <span
                  className="gap-1 bg-primary-100 text-primary-800 text-xs font-medium inline-flex items-center px-2.5 py-0.5 rounded dark:bg-primary-200 dark:text-primary-800">
                ...
                Changelog
                            ...
                            <p className="mb-5 font-light text-gray-500 dark:text-gray-400">
                                ...
                                nam asperiores quam, voluptatum porro cumque ab blanditiis in
                                dolorum laboriosam fuga non. Nulla suscipit corporis error illo
                                iste perferendis adipisci!
                            </p>
                            <div className="flex justify-between items-center">
                                <div className="flex items-center space-x-4">
                                    ...
                                    />
                                    <span className="font-medium dark:text-white">MrPhil7H48</span>
                                </div>
                                <a
                                    href="#"
              ...
              <span
                ...
                Actus
                            ...
                            <p className="mb-5 font-light text-gray-500 dark:text-gray-400">
                                ...
                                dolore, laboriosam a eveniet hic dolorum animi nam id earum! Ad et
                                illo dolorem deleniti reprehenderit vero libero quibusdam, nulla
                                dolor?
                            </p>
                            <div className="flex justify-between items-center">
                                <div className="flex items-center space-x-4">
